...
const Waves: React.FC<WavesProps> = ({
  ...
  useEffect(() => {
    ...
    function movePoints(time: number) {
      ...
      lines.forEach(pts => {
        pts.forEach(p => {
          ...
          p.wave.x = Math.cos(move) * waveAmpX * motionScale;
          p.wave.y = Math.sin(move) * waveAmpY * motionScale;
          ...
          if (interactive) {
            ...
            if (dist < l) {
              ...
              p.cursor.vx += Math.cos(mouse.a) * f * l * mouse.vs * 0.00065 * motionScale;
              p.cursor.vy += Math.sin(mouse.a) * f * l * mouse.vs * 0.00065 * motionScale;
            }
          }
    ...
    function tick(t: number) {
      ...
      if (t - lastFrameTimeRef.current < minFrameInterval) {
  ...
  }, [interactive, maxFps, motionScale, pixelRatioCap]);
